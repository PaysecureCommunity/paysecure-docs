---
title: "Paysecure TrustScore API"
id: trust-score
description: "Paysecure TrustScore API Documentation"
---
# Paysecure TrustScore API
...
Access to this API is restricted. If you receive a `401` error with "You are not allowed to call this API service," please contact your Paysecure sales representative for access.

## API Endpoint

**POST** `https://api.paysecure.net/api/v1/trustScore`
...
# Paysecure checkTransactionAllowed API
...
**POST** `https://api.paysecure.net/api/v1/checkTransAllowed`
