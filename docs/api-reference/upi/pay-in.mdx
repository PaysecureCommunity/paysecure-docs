...
The `createPurchase` API allows merchants to initiate a purchase transaction via Fundstream. It supports various payment methods, including UPI, and provides necessary details for checkout.
