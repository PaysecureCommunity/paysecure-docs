...
The `createPurchase` API allows merchants to initiate a purchase transaction via Fundstream. It supports various payment methods, and provides necessary details for checkout.
...
(async () => {
  const response = await axios.post(
    "https://staging.fundstream.net/api/v1/purchases",
    {
  "client": {
...
}
{
    ...
    "checkout_url": "https://staging.fundstream.net/payments/66334635a2cf2a7da7b192ab/"
}
``` 