...
### Endpoint
**POST**: Create Payout  
`https://staging.paysecure.net/api/v1/payouts/`
...
(async () => {
  const response = await axios.post(
    "https://api.paysecure.net/api/v1/payouts",
    {
      recipient: {
        email: "john.doe@example.com",
        street_address: "123 Maple Street",
...
### cURL Request
```sh
curl --location 'https://api.paysecure.net/api/v1/payouts' \
...
`https://api.paysecure.net/api/v1/payouts/{payoutId}/`
...
### cURL Request
```sh
curl --location 'https://api.paysecure.net/api/v1/payouts/61f8c0a5e4b06a7c9d1e2f3c' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer your-token-here'
```
